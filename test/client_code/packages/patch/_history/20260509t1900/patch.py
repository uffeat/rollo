def main(use, *args, **kwargs):
    ...
    class patch:
        """Utility for patching members onto target."""
        def __init__(self, target):
            self._ = dict(target=target)

        def method(self, method, name: str = None) -> "patch":
        ...
        def property(self, *args, name: str = None) -> "patch":
            ...
            Object.defineProperty(self._['target'], name, options)
            return self
