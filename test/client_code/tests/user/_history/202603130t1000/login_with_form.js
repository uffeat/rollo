...
export default async () => {
  ...
  function debounce(node) {
    ...
    timer.timer = setTimeout(() => {
      const visible = document.body.contains(node);
  ...
  function onModalOpened(node) {
    // Handle fresh modal open
  }

  function onModalClosed(node) {
    // Handle final modal close
  }
