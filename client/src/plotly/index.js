...
connect LC. Plot data, layout and config are all reset when disconnected.

If this is too much "mount/unmont" either keep the component connected, store
data, layout and config externally or roll your own.
Goodies:
...
export const Plot = author(
  class extends mix(HTMLElement, {}, ...Mixins(stateMixin)) {
    ...
    connectedCallback() {
      ...
      this.#_.config = this.#_.data = this.#_.layout = null;
