export class Path {
  ...
  constructor(specifier) {
    this.construct(specifier);
    this.#_.constructed = false;
  }

  /* Returns flag that reveals, if path has been constructed. */
  get constructed() {
    return this.#_.constructed;
  }
  ...
  /* Returns 'Path' instance created from specifier.
  NOTE Effectively allows mutation. */
  construct(specifier) {
