...
class A {
    ...
    this.#t.$ = new Proxy(() => {
      ...
      add(f, ...y) {
        const {
          ...
          once: O = !1,
          run: m = !0
        } = y.find((b, L) => !L && d.object(b)) || {}, v = y.filter((b) => d.function(b)), _ = T.create({ owner: e }), R = e.effects.add(
          (b, L) => {
            _.update(f(b, L));
          },
          { data: j, once: O, run: m }
  ...
  update(...t) {
    let e = t.find((u, a) => !a);
    const { detail: s, silent: n = !1 } = t.find((u, a) => a && d.object(u)) || {};
...
const de = (...r) => A.create(...r).$, ht = (...r) => {
...
}, st = "$", lt = st.length, I = (r) => class extends r {
  ...
  update(t = {}) {
    return super.update?.(t), this.$(
      Object.fromEntries(
        Object.entries(t).filter(([e, s]) => e.startsWith(st)).map(([e, s]) => [e.slice(lt), s])
      )
    ), this;
  }
...
const je = (r) => /^[A-Z]/.test(r), ve = (r) => (r.length > 0 && (r = r[0].toUpperCase() + r.slice(1)), r), _t = (r, t) => class extends r {
...
const Ee = (r, t, e, {
  ...
  writable: o,
  value: e
}), r), Oe = (r, t, { bind: e = !0, configurable: s = !0, enumerable: n = !1, get: i, set: o } = {}) => {
  e && (i = i.bind(r));
  const c = {
    configurable: s,
    enumerable: n,
          ...
          */
          get(u, a) {
            return (...p) => {
              ...
              if (a === "use")
                return s.addEventListener(c, l, h);
              if (a === "unuse")
                return s.removeEventListener(c, l, h);
...
const Ht = (r, t) => class extends r {
  ...
  const n = K("!text", I);
  return "textContent" in e && n.push(N.text), r === "form" && n.push(N.novalidation), r === "label" && n.push(N.for_), U.add(
    class nt extends D(s, {}, ...n) {
      static __key__ = t;
      static __native__ = r;
      static create = (...o) => {
        const c = new nt();
...
const it = (r, t, e) => (U.add(r, t, e), W(r, "create", Z(r)), r.create), Q = "div", Vt = it(
  class extends D(
...
const Gt = new class {
  ...
  if (!d.object(r) || !d.object(t) || Object.keys(r).length !== Object.keys(t).length)
    return !1;
...
const x = new class {
  ...
  async setup({ error: t, redirect: e, routes: s, strict: n = !0 } = {}) {
    return this.#t.config.error = t, this.#t.config.strict = n, Object.assign(this.#t.config.redirect, e), s && this.routes.add({ ...s }), this.#t.initialized || (window.parent.addEventListener("popstate", async (i) => {
...
const et = (r, t) => {
  ...
  for (let s = 0; s < t.length; s++)
    e += String(t[s]) + r[s + 1];
  return e;
}, Me = (r, ...t) => ie(r, t), rt = (r) => Object.fromEntries(
...
const Ze = (r) => Array.from(new Set(r)), De = (r, t = (e) => e) => {
  const e = [];
  for (let s = 0; s < r; s++)
    e.push(t(s, e));
  return e;
}, Fe = (r, t, { abs: e = 1e-4, rel: s = 1e-6 } = {}) => {
  if (r === t) return !0;
