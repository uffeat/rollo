...
!(function (a, i) {
  ...
  function E() {
    for (
      ...
      (e = new Date(r, n, 1).getTimezoneOffset()) !== c &&
        ((a = (function (a, i) {
          for (var e; (e = 6e4 * (((i.at - a.at) / 12e4) | 0)); )
            (e = new M(new Date(a.at + e))).offset === a.offset
              ? (a = e)
              : (i = e);
          return a;
        })(o, (i = new M(new Date(r, n, 1))))),
        A.push(a),
        A.push(new M(new Date(a.at + 6e4))),
        (o = i),
        (c = e));
    for (n = 0; n < 4; n++)
      A.push(new M(new Date(r + n, 0, 1))),
        A.push(new M(new Date(r + n, 6, 1)));
    return A;
  }
  function g(a, i) {
  ...
  function z() {
    ...
    for (
      var e,
        ...
        A = (function (a) {
          for (
            var i, e, r, o = a.length, c = {}, A = [], n = {}, t = 0;
            t < o;
            t++
          )
  ...
  function S(a, i) {
    ...
    return e instanceof b
      ...
      ? ((e = new b(e)), (s[a] = e))
      : c[a] && i !== S && (i = S(c[a], S))
      ? ((e = s[a] = new b())._set(i), (e.name = u[a]), e)
      : null;
  }
  function _(a) {
    var i, e, r, o;
  ...
  function O(a) {
    ...
    return (
      !o.isMoment(a) && B(i) && (a = S(e)) && i.add(a.parse(i), "minutes"),
      i.tz(e),
      i
    );
  }
      ...
      return (
        ...
        (a = A[e] || null)
          ? ((e = a.zones.sort()),
            i
              ? e.map(function (a) {
                  return { name: a, offset: S(a).utcOffset(new Date()) };
                })
              : e)
          : null
      );
  ...
  (o.tz = O),
    ...
    (o.updateOffset = function (a, i) {
      ...
      void 0 === a._z &&
        (r &&
          ...
          !a._isUTC &&
          a.isValid() &&
          ((a._d = o.utc(a._a)._d), a.utc().add(r.parse(a), "minutes")),
        (a._z = r)),
        a._z &&
          ((r = a._z.utcOffset(a)),
          Math.abs(r) < 16 && (r /= 60),
    ...
    (a.zoneName = G(a.zoneName)),
    (a.zoneAbbr = G(a.zoneAbbr)),
    (a.utc = D(a.utc)),
    (a.local = D(a.local)),
    (a.utcOffset =
      ((y = a.utcOffset),
      function () {
        return (
          0 < arguments.length && (this._z = null), y.apply(this, arguments)
        );
      })),
  ...
  return (
    ...
    !1 === o.suppressDeprecationWarnings &&
      ...
      console.warn &&
      console.warn(
        "Deprecation warning: Moment Timezone has been loaded from a file containing data from 2012 to 2022 only. This file is out of date and may be removed in a future release. Dates and times for the current year might be incorrect."
      ),
    o
  );
});
