...
from anvil.js.window import Array, Blob, Function, Object, URL
...
class js:
    ...
    @staticmethod
    def signature(args, kwargs) -> tuple:
        """Returns Python interpretation of JS arguments.
        NOTE Call inside body of Python function/method."""
        args = list(args)
        _kwargs = args.pop() if (args and typeName(args[-1]) == 'Object') else {}
